...
class MeasurementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create measurement" do
    assert_difference('Measurement.count') do
      post measurements_url, params: { measurement: { date_time: @measurement.date_time, notes: @measurement.notes, value: @measurement.value } }
    end
  ...
  test "should update measurement" do
    patch measurement_url(@measurement), params: { measurement: { date_time: @measurement.date_time, notes: @measurement.notes, value: @measurement.value } }
